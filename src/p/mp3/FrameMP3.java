 ...
 *
 */
public class FrameMP3{
    private static final Logger logger = Logger.getLogger(FrameMP3.class);
    ...
    {
        String s = "F:\\tem\\MILENIO3 - Programas Emitidos en MAR + ABR-04 (176-192)";
...
//        System.out.println("Listo ");
    ...
    public FrameMP3(String path) throws Exception
    {
      this(new File(path));
    }

    public FrameMP3(File file)
    {
    ...
    public FrameMP3(RandomAccessFile raf) throws Exception {
        init(raf);
    }


    public FrameMP3(int[] unsignedBytes) throws Exception    {
