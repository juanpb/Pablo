...
public class Helper implements Defines {
     ...
     * MSB first.
     *
     * @param b any number of bytes together denoting a number not bigger than
     ...
     *
     * @param value  a value.. Sensibly one that fits into the given number of
     *               bytes
     ...
     *
     * @param size      number of bytes the new buffer should be bigger than the old
     ...
     *
     * @param encByte byte-representation of the encoding
     ...
     *
     * @param encoding a number from 0 to 3 (as of now)
     ...
     *
     * @param bAr      contains the data
     * @param encoding one of the 4 encodings used in ID3V2 tags.
     ...
     *
     * @param encoding the used encoding as allowed in ID3V2
