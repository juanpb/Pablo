...
public class LRCero{
    ...
    Grafo   _grafo;
    Vector  _estados;
    int _tieneConflicto = 0; // está en 0 hasta que se verifica
    ...
    public LRCero(GLC gram) throws Exception {
        ...
        for (int i = 0 ; i < nodos.size() ; i++){           //para cada nodo
            ...
            for (int j = 0 ;  j < items.size(); j++){       //para cada ítem
                ...
                //hay que agregar 'Reduce'
                    ...
                    //Lleno en todas las columnas de terminales (las columnas
                    //están representadas por los símbolos de la gramática)
