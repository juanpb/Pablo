 ...
 *
 */
public class WflAddVerticeAction extends AbstractAction {
	private static final long serialVersionUID = 1L;
	public static final int NO_X_COORDINATE = -1;
	public static final int NO_Y_COORDINATE = -1;
	
    private static String title = "Agregar Vertice";
    ...
    public WflAddVerticeAction(WflContainerControl control,  WflConnector connector) {
        this(control, connector, true);
    }

    public WflAddVerticeAction(WflContainerControl control, WflConnector connector, boolean showText) {
    ...
    private Icon getIcon() {
        String ic = null;
        ic = WflConstants.ICON_VERTICE_ADD;
        return WflUtil.createImageIcon(ic);
    }

    public void actionPerformed(ActionEvent e) {
       	connector.addVertice(connector.getX() + this.x, connector.getY() + this.y);
